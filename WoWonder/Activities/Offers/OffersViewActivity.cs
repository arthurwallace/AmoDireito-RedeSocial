...
namespace WoWonder.Activities.Offers
{
    ...
    public class OffersViewActivity : AppCompatActivity, MaterialDialog.IListCallback, MaterialDialog.ISingleButtonCallback
    {
                ...
                if (DialogType == "Delete")
                {
                    if (p1 == DialogAction.Positive)
                    {
                        ...
                        if (Methods.CheckConnectivity())
                        {
                            ...
                            var dataGlobal = diff?.Where(a => a.PostData?.OfferId == DataInfoObject?.Id);
                            if (dataGlobal != null)
                            {
                            ...
                            var dataGlobal2 = recycler?.NativeFeedAdapter.ListDiffer?.Where(a => a.PostData?.OfferId == DataInfoObject?.Id);
                            if (dataGlobal2 != null)
                            {
