                ...
                switch (TypePost)
                {
                    case PostModelType.EventPost:
                    {
                        if (DataPost.Event?.EventClass != null)
                            ...
                            {
                                Title = DataPost.Event.Value.EventClass.Name,
                                Text = DataPost.Event.Value.EventClass.Description,
                    ...
                    { 
                        ...
                        await ShareFileImplementation.ShareRemoteFile(urlImage, urlImage?.Split('/').Last(), Context.GetText(Resource.String.Lbl_Send_to));
                        break;
                    }
                    ...
                    case PostModelType.VideoPost:
                    {
                        ...
                        await ShareFileImplementation.ShareRemoteFile(linkUrl, linkUrl?.Split('/').Last(), Context.GetText(Resource.String.Lbl_Send_to));
                        break;
                    }
                    ...
                    case PostModelType.ProductPost:
                    {
                        if (DataPost.Product != null)
                            await CrossShare.Current.Share(new ShareMessage
                            {
                                Title = DataPost.Product.Value.ProductClass.Name,
                                Text = DataPost.Product.Value.ProductClass.Description,
