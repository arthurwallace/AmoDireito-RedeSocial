...
{ 
    public enum PostModelType
    {
        ...
        MultiImage3 = 27, MultiImage4 = 28, MultiImages = 29, PollPost = 30, AdsPost = 31, AdMob = 32, JobPost =33, AlertBoxAnnouncement = 34, FundingPost = 35 , PurpleFundPost = 36 , SocialLinks = 37 , SuggestedGroupsBox = 38,
