...
namespace WoWonder.Activities.DialogUser
{
    public class DialogBlockUser : Android.Support.V4.App.DialogFragment
    {
        ...
        public abstract class BlockUserUpEventArgs : EventArgs
        {
        ...
        protected virtual void OnOnBlockUserUpComplete(BlockUserUpEventArgs e)
        {
            OnBlockUserUpComplete?.Invoke(this, e);
