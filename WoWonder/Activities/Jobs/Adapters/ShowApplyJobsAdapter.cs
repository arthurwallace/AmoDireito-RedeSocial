...
namespace WoWonder.Activities.Jobs.Adapters
{
    public class ShowApplyJobsAdapter : RecyclerView.Adapter, ListPreloader.IPreloadModelProvider
    {
        ...
        public override RecyclerView.ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
        {
            try
            {
                ...
                var vh = new ShowApplyJobsAdapterViewHolder(itemView, Click, LongClick);
                return vh;
            }
    ...
    { 
        ...
        public ShowApplyJobsAdapterViewHolder(View itemView, Action<ShowApplyJobsAdapterClickEventArgs> clickListener, Action<ShowApplyJobsAdapterClickEventArgs> longClickListener) : base(itemView)
        {
            try
            {
                MainView = itemView;
